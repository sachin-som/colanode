...
export enum MutationErrorCode {
  ...
  EntryCollaboratorCreateForbidden = 'entry_collaborator_create_forbidden',
  EntryCollaboratorCreateFailed = 'entry_collaborator_create_failed',
  EntryCollaboratorDeleteForbidden = 'entry_collaborator_delete_forbidden',
  EntryCollaboratorDeleteFailed = 'entry_collaborator_delete_failed',
  EntryCollaboratorUpdateForbidden = 'entry_collaborator_update_forbidden',
  EntryCollaboratorUpdateFailed = 'entry_collaborator_update_failed',
  ...
  MessageReactionCreateForbidden = 'message_reaction_create_forbidden',
}
