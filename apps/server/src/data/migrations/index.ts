...
import { createVectorExtension } from './00014-create-vector-extension';
import { createNodeEmbeddingsTable } from './00015-create-node-embeddings-table';
import { createDocumentEmbeddingsTable } from './00016-create-document-embeddings-table';
...
export const databaseMigrations: Record<string, Migration> = {
  ...
  '00014_create_vector_extension': createVectorExtension,
  '00015_create_node_embeddings_table': createNodeEmbeddingsTable,
  '00016_create_document_embeddings_table': createDocumentEmbeddingsTable,
};
